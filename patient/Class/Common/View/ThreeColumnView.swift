...
class ThreeColumnView: BaseView {
    ...
    var config: ThreeColumnViewConfig! {
        didSet {
    ...
    var items: [ThreeColumnViewModelProtocol]! {
        didSet {
    ...
    var rowInstances = [RowInstance]()
}

// MARK: - UI
extension ThreeColumnView {
    // MARK: - UI
    func setup() {
        addHeaderView()
        addRowsView()
